...
urlpatterns = [
    ...
    path("ai-profiles/", include(("ai_profiles.urls", "ai_profiles"), namespace="AI Profiles")),
    path("chat-module/", include(("chat_module.urls", "chat_module"), namespace="Chat Module")),
