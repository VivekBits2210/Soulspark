...
def fill_db(request):
    ...
    profile1_data = {
        ...
        'profile_image': SimpleUploadedFile("Nicole.jpg", image_content1, content_type="image/jpeg"),
        'bio': 'Lorem ipsum'
    }
    profile2_data = {
        'name': 'Carla',
        ...
        'profile_image': SimpleUploadedFile("Carla.jpg", image_content2, content_type="image/jpeg"),
        'bio': 'Lorem ipsum'
    }
