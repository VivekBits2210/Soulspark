...
from ai_profiles.views import customize_profile, create_profile_admin, fetch_profile, index
...
urlpatterns = [
    ...
    path('customize-profile', customize_profile.customize_profile, name='customize_profile'),
