...
def create_user(username='testuser', password='testpass', age=25, gender='M', gender_focus='F',
                interests='test,python'):
    user = User.objects.create(username=username, password=password)
    UserProfile.objects.create(user=user, age=age, gender=gender, gender_focus=gender_focus, interests=interests)
    return user
