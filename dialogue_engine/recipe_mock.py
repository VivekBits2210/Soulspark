class RecipeMock():
    ...
    def construct_story_system_message(self):
        return f"This is a story about {self.user_profile.name} and {self.bot.name}. {self.bot.summary} {self.user_profile.summary} " \
    ...
    def construct_indicator_system_message(self):
        return "Randomly fill values for x1,x2...xn: " \
               "'sadness:x1/10|happiness:x2/10'", {'temperature': 0}
