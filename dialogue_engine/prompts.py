try:
    ...
    story_prompt = lambda u, b: \
        f"This is a story about {u.name} and {b.name}. {b.summary} {u.summary} Behave as {bot.name}, a very " \
...
#     from dialogue_engine.recipe import story_prompt
#
#     bot = BotProfile.objects.get(name="Carla")
#     user_profile = UserProfile.objects.order_by('?').first()
#     client = GPTClient()
#     messages = [
#         {"role": "system", "content": story_prompt(user_profile, bot)},
