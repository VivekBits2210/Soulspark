...
def raw():
    ...
    api_parameters = {'engine': "text-davinci-002",
                      'temperature': 0.1,
                      'max_tokens': 500
                      }
    age = list(range(18, 27))
    occupation_list = ["Air Hostess", "Personal Assistant", "Actress", "Ring Girl", "Receptionist", "Massage Therapist",
                       "Swim wear Model", "Business Executive", "Makeup Artist", "Beautiful Teacher", "Waitress",
                       "Personal Trainer", "News Reporter", "Real Estate Agent"]
    hobby_list = ["Blogging", "Shopping", "Knitting", "Origami", "Dancing", "Painting", "Singing", "Gymnastics",
                  "Singing", "Snowboarding", "Writing", "Photography", "Jewelry"]
    fav = ["cats",
           "k-pop",
